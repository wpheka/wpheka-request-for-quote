...
final class WPHEKA_Rfq {
    ...
    public function includes() {
         ...
         * Core classes.
         */
        include_once WPHEKA_RFQ_PLUGIN_ABSPATH . 'includes/class-wpheka-request-for-quote-install.php';
        include_once WPHEKA_RFQ_PLUGIN_ABSPATH . 'includes/class-wpheka-request-for-quote-shortcodes.php';

        // Include admin class
        if ( $this->is_request( 'admin' ) ) {
            include_once WPHEKA_RFQ_PLUGIN_ABSPATH . 'includes/admin/class-wpheka-request-for-quote-admin.php';
        }
        ...
        if ( $this->is_request( 'frontend' ) ) {
            ...
            include_once WPHEKA_RFQ_PLUGIN_ABSPATH . 'includes/class-wpheka-request-for-quote-session-handler.php';
            include_once WPHEKA_RFQ_PLUGIN_ABSPATH . 'includes/class-wpheka-request-for-quote-frontend.php';
        }

        // Include ajax class
        if ( $this->is_request( 'ajax' ) ) {
            include_once WPHEKA_RFQ_PLUGIN_ABSPATH . 'includes/class-wpheka-request-for-quote-ajax.php';
        }
    ...
    */
    ...
    public function include_rfq_emails( $email_classes ) {
        ...
        $email_classes['WPHEKA_Rfq_Mail'] = include WPHEKA_RFQ_PLUGIN_ABSPATH . 'includes/emails/class-wpheka-request-for-quote-mail.php';
        return $email_classes;
    }
