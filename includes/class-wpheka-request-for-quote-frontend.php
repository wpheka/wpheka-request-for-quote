	...
	class WPHEKA_Rfq_Frontend {
        ...
        public function enqueue_styles_scripts() {
            ...
            if( (wpheka_request_for_quote()->is_rfq_page()) || (wpheka_request_for_quote()->is_product_page())) {
				...
				wp_enqueue_style( 'wpheka_rfq_frontend_css', $WPHEKA_Rfq->plugin_url . 'assets/frontend/css/dist/components/style.css', array(), '1.0' );
				
				// Enqueue loading overlay
                wp_enqueue_script( 'wpheka_rfq_loadingoverlay_js', $WPHEKA_Rfq->plugin_url . 'assets/frontend/js/loadingoverlay.min.js', array( 'jquery' ), '2.1.7', true );
				
				// Enqueue plugin frontend js
				wp_register_script( 'wpheka_rfq_frontend_single_js', $WPHEKA_Rfq->plugin_url . 'assets/frontend/js/frontend.js', array( 'jquery', 'jquery-blockui', 'wpheka_rfq_loadingoverlay_js' ), '1.0', true );

                $localize_script_args = array(
					'ajax_url'   => admin_url( 'admin-ajax.php' ),
					'i18n_no_matching_variations_text' => esc_attr__( 'Sorry, no products matched your selection. Please choose a different combination.', wpheka_request_for_quote()->text_domain ),
					'i18n_make_a_selection_text'       => esc_attr__( 'Please select some product options before adding this product to your cart.', wpheka_request_for_quote()->text_domain ),
					'i18n_unavailable_text'            => esc_attr__( 'Sorry, this product is unavailable. Please choose a different combination.', wpheka_request_for_quote()->text_domain ),
                ...
                wp_enqueue_style( 'wpheka_rfq_frontend_css', $WPHEKA_Rfq->plugin_url . 'assets/frontend/css/frontend.css', array(), '1.0' );
			...
			if( is_shop() || is_product_taxonomy() ) {
				...
				wp_register_script( 'wpheka_rfq_frontend_js', $WPHEKA_Rfq->plugin_url . 'assets/frontend/js/rfq.js', array( 'jquery' ), '1.0', true );
        ...
        public function add_button_product_page() {
            ...
            wc_get_template(
                'single-product/add-to-quote.php', array(
